...
public class OrganizationRestResource extends PartyRestResource<Organization, OrganizationDto, OrganizationCriteria, OrganizationRepository, OrganizationService> {
    public static final String BASE_URI = "/api/v1/" + Organization.DOMAIN_NAME_WITH_HYPHEN;

    protected OrganizationRestResource(UserService userService, OrganizationService service) {
