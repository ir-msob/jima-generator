package <%= packagePath %>.<%= projectNameLowercase %>.core.commons.party.name;

import com.fasterxml.jackson.annotation.JsonInclude;
import <%= packagePath %>.<%= projectNameLowercase %>.core.commons.jima.childdomain.criteria.ChildCriteriaAbstract;
