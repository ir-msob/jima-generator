package <%= packagePath %>.<%= projectNameLowercase %>.core.service.jima.crud.kafka.domain.service.write;
...
public interface UpdateByIdDomainCrudKafkaListener<
        ...
        > extends BaseUpdateByIdDomainCrudKafkaListener<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S>
