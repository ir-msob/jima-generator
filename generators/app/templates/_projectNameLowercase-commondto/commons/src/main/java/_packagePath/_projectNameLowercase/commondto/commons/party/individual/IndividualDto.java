...
public class IndividualDto extends Individual implements Dto {
    ...
    @Builder
    public IndividualDto(String id, SortedSet<Characteristic> characteristics, SortedSet<ContactMedium> contactMediums, SortedSet<ObjectValidation> objectValidations, SortedSet<RelatedAction> relatedActions, SortedSet<Name> names) {
