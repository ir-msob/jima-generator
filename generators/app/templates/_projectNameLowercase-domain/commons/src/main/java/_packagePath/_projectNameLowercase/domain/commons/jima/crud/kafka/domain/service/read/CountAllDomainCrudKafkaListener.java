package <%= packagePath %>.<%= projectNameLowercase %>.domain.commons.jima.crud.kafka.domain.service.read;
...
public interface CountAllDomainCrudKafkaListener<
        ...
        > extends BaseCountAllDomainCrudKafkaListener<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S>
