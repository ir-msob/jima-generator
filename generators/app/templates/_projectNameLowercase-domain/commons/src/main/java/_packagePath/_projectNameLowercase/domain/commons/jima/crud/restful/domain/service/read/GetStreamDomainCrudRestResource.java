package <%= packagePath %>.<%= projectNameLowercase %>.domain.commons.jima.crud.restful.domain.service.read;
...
public interface GetStreamDomainCrudRestResource<
        ...
        > extends BaseGetStreamDomainCrudRestResource<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
