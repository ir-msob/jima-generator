package <%= packagePath %>.<%= projectNameLowercase %>.domain.commons.jima.security.keycloak;

import <%= packagePath %>.<%= projectNameLowercase %>.domain.commons.jima.security.Roles;
