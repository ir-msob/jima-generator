...
import ir.msob.jima.crud.api.restful.service.domain.read.BaseCountCrudRestResource;
...
public interface CountCrudRestResource<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseCountCrudRestResource<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
}