...
import ir.msob.jima.crud.api.restful.service.domain.read.BaseCountAllCrudRestResource;
...
public interface CountAllCrudRestResource<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseCountAllCrudRestResource<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
