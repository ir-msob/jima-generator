...
import ir.msob.jima.crud.api.restful.service.domain.write.BaseDeleteCrudRestResource;
...
public interface DeleteCrudRestResource<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseDeleteCrudRestResource<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
