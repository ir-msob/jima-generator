...
import ir.msob.jima.crud.api.restful.service.domain.read.BaseGetManyCrudRestResource;
...
public interface GetManyCrudRestResource<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseGetManyCrudRestResource<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
