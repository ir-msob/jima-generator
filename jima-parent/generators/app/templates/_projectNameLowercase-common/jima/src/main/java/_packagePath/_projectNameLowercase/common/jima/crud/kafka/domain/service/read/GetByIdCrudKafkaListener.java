...
import ir.msob.jima.crud.api.kafka.service.domain.read.BaseGetByIdCrudKafkaListener;
...
public interface GetByIdCrudKafkaListener<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseGetByIdCrudKafkaListener<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
