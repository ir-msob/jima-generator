...
import ir.msob.jima.crud.api.kafka.service.domain.write.BaseEditByIdCrudKafkaListener;
...
public interface EditByIdCrudKafkaListener<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseEditByIdCrudKafkaListener<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
