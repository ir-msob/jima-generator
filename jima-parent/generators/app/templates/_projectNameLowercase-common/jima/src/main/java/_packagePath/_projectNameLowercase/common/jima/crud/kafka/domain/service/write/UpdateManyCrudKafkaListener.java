...
import ir.msob.jima.crud.api.kafka.service.domain.write.BaseUpdateManyCrudKafkaListener;
...
public interface UpdateManyCrudKafkaListener<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseUpdateManyCrudKafkaListener<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
