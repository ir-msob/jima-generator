...
import ir.msob.jima.crud.api.restful.service.domain.write.BaseUpdateByIdCrudRestResource;
...
public interface UpdateByIdCrudRestResource<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseUpdateByIdCrudRestResource<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
