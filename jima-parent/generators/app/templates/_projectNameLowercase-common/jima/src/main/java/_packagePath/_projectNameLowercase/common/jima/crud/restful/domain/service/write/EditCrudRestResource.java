...
import ir.msob.jima.crud.api.restful.service.domain.write.BaseEditCrudRestResource;
...
public interface EditCrudRestResource<
        ...
        > extends BaseEditCrudRestResource<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
