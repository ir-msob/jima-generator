...
import ir.msob.jima.crud.api.restful.service.domain.write.BaseDeleteManyCrudRestResource;
...
public interface DeleteManyCrudRestResource<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseDeleteManyCrudRestResource<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
