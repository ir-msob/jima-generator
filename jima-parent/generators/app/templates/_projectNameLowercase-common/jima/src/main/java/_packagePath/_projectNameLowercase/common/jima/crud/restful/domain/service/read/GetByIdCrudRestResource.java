...
import ir.msob.jima.crud.api.restful.service.domain.read.BaseGetByIdCrudRestResource;
...
public interface GetByIdCrudRestResource<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseGetByIdCrudRestResource<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
