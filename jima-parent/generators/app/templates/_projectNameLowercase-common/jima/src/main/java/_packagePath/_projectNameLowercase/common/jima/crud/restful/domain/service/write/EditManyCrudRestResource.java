...
import ir.msob.jima.crud.api.restful.service.domain.write.BaseEditManyCrudRestResource;
...
public interface EditManyCrudRestResource<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseEditManyCrudRestResource<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
