...
import ir.msob.jima.crud.api.kafka.service.domain.write.BaseDeleteCrudKafkaListener;
...
public interface DeleteCrudKafkaListener<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseDeleteCrudKafkaListener<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
