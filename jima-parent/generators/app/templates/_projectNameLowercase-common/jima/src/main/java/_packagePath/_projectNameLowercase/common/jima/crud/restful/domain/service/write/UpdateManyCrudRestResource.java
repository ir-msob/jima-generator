...
import ir.msob.jima.crud.api.restful.service.domain.write.BaseUpdateManyCrudRestResource;
...
public interface UpdateManyCrudRestResource<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseUpdateManyCrudRestResource<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
