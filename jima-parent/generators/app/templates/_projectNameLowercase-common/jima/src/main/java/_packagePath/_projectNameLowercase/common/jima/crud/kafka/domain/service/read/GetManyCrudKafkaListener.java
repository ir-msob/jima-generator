...
import ir.msob.jima.crud.api.kafka.service.domain.read.BaseGetManyCrudKafkaListener;
...
public interface GetManyCrudKafkaListener<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseGetManyCrudKafkaListener<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
