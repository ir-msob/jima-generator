...
import ir.msob.jima.crud.api.kafka.service.domain.write.BaseSaveManyCrudKafkaListener;
...
public interface SaveManyCrudKafkaListener<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseSaveManyCrudKafkaListener<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
