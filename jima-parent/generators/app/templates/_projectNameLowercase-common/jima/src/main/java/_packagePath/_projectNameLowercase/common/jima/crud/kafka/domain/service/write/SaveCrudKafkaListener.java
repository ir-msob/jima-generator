...
import ir.msob.jima.crud.api.kafka.service.domain.write.BaseSaveCrudKafkaListener;
...
public interface SaveCrudKafkaListener<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseSaveCrudKafkaListener<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
