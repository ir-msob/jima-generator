...
import ir.msob.jima.crud.api.kafka.service.domain.write.BaseUpdateCrudKafkaListener;
...
public interface UpdateCrudKafkaListener<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseUpdateCrudKafkaListener<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
