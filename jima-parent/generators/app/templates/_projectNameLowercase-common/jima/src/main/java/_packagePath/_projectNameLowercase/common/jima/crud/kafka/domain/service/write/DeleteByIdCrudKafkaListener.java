...
import ir.msob.jima.crud.api.kafka.service.domain.write.BaseDeleteByIdCrudKafkaListener;
...
public interface DeleteByIdCrudKafkaListener<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends CrudRepository<D, C>,
        S extends CrudService<D, DTO, C, R>
        > extends BaseDeleteByIdCrudKafkaListener<<%= idClassName %>, User, D, DTO, C, QueryBuilder, R, S> {
