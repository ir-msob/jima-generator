package <%= packagePath %>.<%= projectNameLowercase %>.common.commons.jima.security.keycloak;

import <%= packagePath %>.<%= projectNameLowercase %>.common.commons.jima.security.Roles;
