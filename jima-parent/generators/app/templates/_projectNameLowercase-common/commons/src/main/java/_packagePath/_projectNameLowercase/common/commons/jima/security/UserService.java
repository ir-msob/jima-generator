package <%= packagePath %>.<%= projectNameLowercase %>.common.commons.jima.security;

import <%= packagePath %>.<%= projectNameLowercase %>.common.commons.jima.security.keycloak.BaseKeycloakUserService;
