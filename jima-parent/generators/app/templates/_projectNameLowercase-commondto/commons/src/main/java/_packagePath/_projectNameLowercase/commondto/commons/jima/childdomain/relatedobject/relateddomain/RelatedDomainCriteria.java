package <%= packagePath %>.<%= projectNameLowercase %>.commondto.commons.jima.childdomain.relatedobject.relateddomain;
...
public class RelatedDomainCriteria extends RelatedDomainCriteriaAbstract<<%= idClassName %>, RelatedDomain> {
